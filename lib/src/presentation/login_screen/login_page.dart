                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                       // const SizedBox(height: 20,),
                        ...
                        const SizedBox(height: 50,),
                         ButtonWidget(buttonTextContent: 'START',onPressed:()=>Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>const BottomNavBarPage()), (route) => false) ,),
                        const SizedBox(height: 20,),
                        InkWell(
